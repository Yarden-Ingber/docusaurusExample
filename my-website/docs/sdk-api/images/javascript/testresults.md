...
See [`SessionUrls`](https://applitools.com/docs/api/eyes-sdk/index-gen/class-sessionurls-images-javascript.html)
...
Aborted means that [Eyes.abort](./eyes#abort-method) or [Eyes.abortIfNotClosed](./eyes#abortifnotclosed-method) was/were called instead of [close](./eyes#close-method).
