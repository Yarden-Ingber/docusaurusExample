...
eyes.check({ accessibilityRegions: value });
 ...
 Type: 
 `( | { region: RegionPlain | Element | Selector; type?: | [AccessibilityRegionType](./accessibilityregiontype) | "BoldText" | "GraphicalObject" | "IgnoreContrast" | "LargeText" | "RegularText"; } | RegionPlain | Element | Selector )[];` 
...
Available match level values are: 
 `[MatchLevel](./matchlevel)|'Content'|'Exact'|'Layout'|'Layout2'|'Layout1'|'None'|'Strict'` 
